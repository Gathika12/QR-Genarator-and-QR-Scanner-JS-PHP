 		...
 		<div class="row">
 			...
 			<div class="col-md-4 mx-auto" id="myform">
				 ...
				 <div class="form-group">
 						...
 						<input type="text" name="stuid" class="form-control" placeholder="Enter Student ID">
 					</div>
 					<div class="form-group">
					 ...
					 <div class="form-group">
    <label>Grade:</label>
    <input type="number" name="grade" class="form-control" placeholder="Enter Grade" min="0" max="100">
</div>
